        ...
        <div className="container">
          ...
          <div className="row download-buttons">
            <div className="col col--4">
              <a href="https://api.ytmatrix.com/front-api/download-windows?app=videomagic" className="download-card">
            ...
            <div className="col col--4">
              <div className="download-card mac-card">
                ...
                <a href="https://api.ytmatrix.com/front-api/download-mac?app=videomagic" className="download-btn">
                  <Translate
