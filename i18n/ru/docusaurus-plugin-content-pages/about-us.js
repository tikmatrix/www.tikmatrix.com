...
export default function AboutUs() {
    return (
        <Layout
            title="О нас"
            description="Узнайте больше о TikZenX - кто мы, наша миссия и видение">
            <div className="container">
                <div className={styles.aboutContent}>
                    <h1>О нас</h1>

                    <h2>О компании</h2>
                    <p>TikZenX разработан компанией TikZenX LLC, зарегистрированной в штате Вайоминг, США. С момента основания мы посвятили себя созданию инновационных инструментов для маркетинга в социальных сетях, помогая предприятиям и создателям контента максимизировать их онлайн-влияние.</p>
                    ...
                    <h2>Наши продукты</h2>
                    <p>Наш флагманский продукт TikZenX разработан для профессионального управления аккаунтами TikTok и автоматизации маркетинга. Мы также предоставляем дополнительные инструменты для других платформ:</p>
                    <ul>
                        <li><strong>TikZenX</strong> - Профессиональный инструмент управления аккаунтами TikTok и маркетинга</li>
                    ...
                    <p>Независимо от того, являетесь ли вы владельцем малого бизнеса, создателем контента или маркетинговым специалистом, TikZenX предоставляет инструменты, необходимые для успеха в сегодняшней конкурентной среде социальных сетей. Наша команда посвящена помощи в достижении ваших маркетинговых целей и расширении онлайн-влияния.</p>
