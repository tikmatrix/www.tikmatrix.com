...
В настоящее время локальное API поддерживает скрипты `post`, `follow`, `unfollow` и `account_warmup`. Поддержка других скриптов будет добавлена в будущих версиях.
:::
...
| `comment` | Оставить комментарий | 🔜 Скоро |
