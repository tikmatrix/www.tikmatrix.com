...
Функциональность белой метки доступна исключительно для пользователей с **годовой подпиской**. Свяжитесь с нашей службой поддержки через [Telegram](https://t.me/tikmatrix), чтобы получить код разблокировки после покупки годового плана.
:::

Функция белой метки позволяет настроить брендинг TikZenX в соответствии с корпоративной идентичностью вашей компании. Вы можете изменить название приложения, логотип и информацию о бренде, чтобы создать персонализированную версию TikZenX.
...
1. Запустите приложение TikZenX
...
3. Свяжитесь с поддержкой через [Telegram](https://t.me/tikmatrix)
...
**Нужен код разблокировки?** Свяжитесь с нашей службой поддержки через [Telegram](https://t.me/tikmatrix) с деталями вашей годовой подписки.
