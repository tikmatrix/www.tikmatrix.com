...
- Network recommendation: ensure your computer and the CloudPhone data center have sufficient, stable network bandwidth. For best reliability of automated tasks, it's recommended that your computer and the cloud phone's data center are located in the same country or region to reduce latency and packet loss.
