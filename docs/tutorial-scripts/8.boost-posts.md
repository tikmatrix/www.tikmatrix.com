...
This functionality has been integrated into [Super Boost](./14.super-boost.md). Please use the Super Boost script for more powerful and flexible post-boosting features.
:::
...
## Using the Boost Posts feature in Super Boost
